...
if __name__ == '__main__':
    ...
    schedule_this_week = {}
    schedule_this_week['team1_id'] = [pdizz_id, pdizz_id, pdizz_id, nate_id, nate_id, deising_id]
    schedule_this_week['team2_id'] = [nate_id, deising_id, ryne_id, deising_id, ryne_id, ryne_id]
